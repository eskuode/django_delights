    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('OC', 'ounces'), ('LB', 'lbs'), ('G', 'grams'), ('EG', 'eggs'), ('OT', 'other')], default='OT', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(blank=True, default=datetime.datetime(2023, 10, 17, 11, 48, 4, 119794))),
                ('menu_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.menuitem')),
            ],
        ),
    ]
